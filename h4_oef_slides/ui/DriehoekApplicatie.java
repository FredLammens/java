...
public class DriehoekApplicatie {
    ...
    public static void main(String[] args) {
        ...
        if (driehoek1.isRechtHoekigeDriehoek() == true)
            System.out.printf("De driehoek met zijden %d , %d , %d is rechthoekig%n",zijde1,zijde2,zijde3);
        else 
            System.out.printf("De driehoek met zijden %d , %d , %d is niet rechthoekig%n",zijde1,zijde2,zijde3);
    }
